...
with visit_costs as (
    select
        ...
        cast(e.base_cost as float) as base_cost,
        cast(e.total_cost as float) as total_cost,
        cast(e.payer_coverage as float) as payer_coverage,
        e.patient_id
...
select
    ...
    cast(null as float) as paid_by_secondary,
    cast(null as float) as paid_by_tertiary,
    cast(null as float) as payer_plan_period_id,
    cast(null as float) as amount_allowed,
    cast(null as float) as revenue_code_concept_id,
    cast(null as text) as revenue_code_source_value,
    cast(null as float) as drg_concept_id,
