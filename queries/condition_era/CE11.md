...
SELECT condition_concept_id,
       ...
       (CAST('0001-01-01' AS DATE) + (AVG(CAST((condition_era_end_date - CAST('0001-01-01' AS DATE)) AS FLOAT))) * INTERVAL '1 day') AS avg_end_date,
       ROUND(STDDEV(CAST((condition_era_end_date - CAST('0001-01-01' AS DATE)) AS FLOAT)),0) AS std_dev_days
  FROM cdm.condition_era
 WHERE condition_concept_id IN  ( 256723, 372906, 440377, 441202, 435371 )
 GROUP BY condition_concept_id
 )
