...
WITH end_rank AS 
  ...
  (SELECT
    ...
    (CAST('0001-01-01' AS DATE) + (AVG(CAST((condition_start_date - CAST('0001-01-01' AS DATE)) AS BIGINT))) * INTERVAL '1 day') AS co_start_date_average,
    STDDEV(((condition_start_date - CAST('0001-01-01' AS DATE))))                                       AS co_start_date_stddev
   FROM cdm.condition_occurrence
...
FROM other_stat,
    (SELECT
      (CAST('0001-01-01' AS DATE) + (AVG(CAST((condition_start_date - CAST('0001-01-01' AS DATE)) AS BIGINT))) * INTERVAL '1 day') AS co_start_date_25percentile
      FROM (
    ...
    (SELECT
      (CAST('0001-01-01' AS DATE) + (AVG(CAST((condition_start_date - CAST('0001-01-01' AS DATE)) AS BIGINT))) * INTERVAL '1 day') AS co_start_date_median
      FROM (
       SELECT condition_start_date, rownumAsc,(SELECT COUNT(*) FROM end_rank ) AS rowno 
         FROM end_rank 
          ) a_1
    ...
    (SELECT
      (CAST('0001-01-01' AS DATE) + (AVG(CAST((condition_start_date - CAST('0001-01-01' AS DATE)) AS BIGINT))) * INTERVAL '1 day') AS co_start_date_75percentile
	      FROM (
       SELECT condition_start_date, rownumAsc,(SELECT COUNT(*) FROM end_rank ) AS rowno 
         FROM end_rank 
         ) a_1
