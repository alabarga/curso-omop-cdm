...
WITH end_rank AS 
  ...
  (SELECT
    ...
    (CAST('0001-01-01' AS DATE) + (AVG(CAST((condition_end_date - CAST('0001-01-01' AS DATE)) AS BIGINT))) * INTERVAL '1 day') AS condition_end_date_average,
    STDDEV((condition_end_date - CAST('0001-01-01' AS DATE)))                                           AS condition_end_date_stddev
   FROM cdm.condition_occurrence
...
FROM other_stat,
    (SELECT (CAST('0001-01-01' AS DATE) + (AVG(CAST((condition_end_date - CAST('0001-01-01' AS DATE)) AS BIGINT))) * INTERVAL '1 day')  AS condition_end_date_25pctile
      FROM (
    ...
    (SELECT (CAST('0001-01-01' AS DATE) + (AVG(CAST((condition_end_date - CAST('0001-01-01' AS DATE)) AS BIGINT))) * INTERVAL '1 day')  AS condition_end_date_median
      FROM (
       SELECT condition_end_date, rownumAsc,(SELECT COUNT(*) FROM end_rank ) AS rowno 
         FROM end_rank 
          ) a_1
    ...
    (SELECT (CAST('0001-01-01' AS DATE) + (AVG(CAST((condition_end_date - CAST('0001-01-01' AS DATE)) AS BIGINT))) * INTERVAL '1 day')AS condition_end_date_75pctile
      FROM (
       SELECT condition_end_date, rownumAsc,(SELECT COUNT(*) FROM end_rank ) AS rowno 
         FROM end_rank 
         ) a_1
