    ...
    ( SELECT
      ...
      FROM
        ( SELECT
            ...
            round((observation_period_end_date - observation_period_start_date), 0 )            AS months /* number of complete years */ ,
            floor(round((observation_period_end_date - observation_period_start_date)/30,0)/12) AS min_count ,
