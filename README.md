...
- Cree y ejecutar consultas para extraer información clínica y relacionada con la población
-Transformar datos al modelo OMOP-CDM

### Esquema del curso:

**Módulo 1: Introducción al modelo de datos OMOP-CDM (2 horas)**
...
- Introducción al ecosistema de la OHDSI
- Resultados del aprendizaje: los participantes comprenderán los conceptos básicos del modelo de datos OMOP-CDM y su papel en proyectos de Real World Evidence

**Módulo 2: Vocabularios OMOP-CDM (2 horas)**
...
**Módulo 3: Transformación a OMOP-CDM  (4 horas)**
- Introducción a las herramientas OHDSI
  - Inspección: WhiteRabbit
  - Mapeo sintáctico: Rabbit-in-a-Hat
  - Mapeo semántico: Usagi
- Ejecución de la transformación

**Módulo 4: Consultas habituales de interés clínico (2 horas)**
- Introducción a SQL
...
**Módulo 5: Introducción a las herramientas de calidad OHDSI (Achilles, DQD, etc) (2 horas)**
